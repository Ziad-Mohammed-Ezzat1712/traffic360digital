...
export default function PortfolioSec1() {
  return (
    <>
      <section className="h-dvh text-white relative container mx-auto flex flex-col justify-center items-center text-center gap-6 ">
       <Navbar/>
        ...
        {/* زر التحميل */}
        <a
          href="/your-pdf.pdf" // غيّر المسار حسب ملفك
          download
